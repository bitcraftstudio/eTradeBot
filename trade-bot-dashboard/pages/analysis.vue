    ...
    <div v-if="analysis" class="space-y-6">
      ...
      <UCard>
        <div class="flex items-center justify-between">
          ...
          <UBadge
            :color="getDecisionColor(recommendation?.decision)"
            size="lg"
      ...
      <UCard>
        ...
        <div class="space-y-4">
          ...
          <div class="p-4 rounded-lg bg-blue-50 dark:bg-blue-900/20">
            ...
            <p class="text-blue-800 dark:text-blue-200">{{ recommendation?.reasoning || 'No reasoning available' }}</p>
          </div>
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-800">
              ...
              <UBadge
                :color="getRiskColor(recommendation?.riskAssessment)"
                size="lg"
                class="mt-2"
              >
          ...
          <div class="grid grid-cols-2 gap-4">
            <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-800">
              ...
              <p class="text-xl font-bold mt-1" :class="recommendation?.expectedReturn >= 0 ? 'text-green-600' : 'text-red-600'">
      ...
      <UCard>
        ...
        <div v-if="technicalAnalysis?.signals?.length" class="mb-4">
          ...
          <div class="flex flex-wrap gap-2">
            <UBadge
              v-for="(signal, idx) in technicalAnalysis.signals"
              :key="idx"
              color="gray"
              variant="subtle"
            >
      ...
      <UCard>
        ...
        <div v-if="sentiment?.articles?.length" class="space-y-3">
          <div
            v-for="(article, idx) in sentiment.articles.slice(0, 5)"
            :key="idx"
