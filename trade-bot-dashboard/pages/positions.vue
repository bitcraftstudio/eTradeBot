<template>
  <div class="space-y-6">
      ...
      <UCard>
        <div class="flex items-center justify-between">
          ...
          <UIcon 
            ...
            :class="totalPnL >= 0 ? 'text-green-500' : 'text-red-500'"
            class="w-8 h-8"
          />
        </div>
      </UCard>
    ...
    <UCard>
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
          ...
          <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Position Monitoring</span>
        </div>
        <div class="flex gap-2">
          ...
          <UButton
            color="primary"
            :loading="checkingSignals"
            @click="checkSellSignals"
          >
    ...
    <!-- Sell Signals Alert -->
    <UAlert
      v-if="sellSignals && sellSignals.totalSignals > 0"
      icon="i-heroicons-bell-alert"
      color="orange"
      variant="soft"
      title="Sell Signals Detected"
    ...
    <div v-if="positions.length > 0" class="space-y-4">
      ...
      >
        <UCard>
          <!-- Sell Signal Banner -->
          <div
            v-if="getSignalForPosition(position.symbol)"
          ...
          <div class="space-y-4">
            ...
            <div class="flex items-start justify-between">
              <div>
                <div class="flex items-center gap-3">
                  ...
                  <UBadge
                    v-else
                    :color="position.unrealizedPnLPercent >= 5 ? 'green' : 'gray'"
                    size="lg"
                  >
            ...
            >
              <div class="flex items-start gap-3">
                <UIcon name="i-heroicons-exclamation-triangle" class="w-5 h-5 text-orange-600 dark:text-orange-400 mt-0.5" />
                <div class="flex-1">
                  ...
                  <div class="flex flex-wrap gap-4 text-xs">
                    <div>
                      ...
                      <span class="font-semibold text-orange-900 dark:text-orange-100 ml-1">
                        {{ (getSignalForPosition(position.symbol).confidence * 100).toFixed(0) }}%
                      </span>
                    </div>
                    <div>
                      <span class="text-orange-700 dark:text-orange-300">Current Gain:</span>
                      <span class="font-semibold text-orange-900 dark:text-orange-100 ml-1">
                    ...
                    <div>
                      <span class="text-orange-700 dark:text-orange-300">Weekly Trend:</span>
                      <UBadge
            ...
            <div class="flex gap-2">
              <UButton
                color="primary"
                variant="outline"
                @click="viewAnalysis(position.symbol)"
              >
                <UIcon name="i-heroicons-chart-bar" class="mr-2" />
                View Analysis
              </UButton>
              <UButton
                :color="getSignalForPosition(position.symbol) ? 'orange' : 'red'"
      ...
      <UCard v-if="selectedAnalysis">
        ...
        <div class="space-y-6">
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div :class="[
              ...
              <p :class="[
                ...
                {{ selectedAnalysis.position.unrealizedPnLPercent >= 0 ? '+' : '' }}{{ selectedAnalysis.position.unrealizedPnLPercent.toFixed(2) }}%
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div :class="[
              ...
              <div class="flex items-center gap-2 mb-2">
                <UBadge
                  :color="selectedAnalysis.sellSignal.shouldSell ? 'orange' : 'green'"
                  size="lg"
                >
              ...
              <div class="grid grid-cols-3 gap-4 mt-3 text-xs">
                <div>
                  <span :class="selectedAnalysis.sellSignal.shouldSell ? 'text-orange-700 dark:text-orange-300' : 'text-green-700 dark:text-green-300'">
                    Current Gain:
                  </span>
                  <span :class="[
                    'font-semibold ml-1',
          ...
          <div v-if="selectedAnalysis.dailySnapshots && selectedAnalysis.dailySnapshots.length > 0">
            ...
            <div class="space-y-2">
              <div
                v-for="(snapshot, idx) in selectedAnalysis.dailySnapshots.slice().reverse()"
                :key="idx"
              ...
              >
                ...
                <div class="text-right">
                  ...
                  <UProgress
                    :value="Math.abs(snapshot.gainPercent)"
                    :color="snapshot.gainPercent >= 0 ? 'green' : 'red'"
                    size="xs"
                    class="w-20"
                  />
                </div>
          ...
          <div class="flex gap-2">
            <UButton
              v-if="selectedAnalysis.sellSignal.shouldSell"
              block
              color="orange"
              @click="sellFromAnalysis"
            >
              Sell Position
            </UButton>
            <UButton
