    ...
    <UCard>
      ...
      <div class="space-y-6">
        ...
        <UAlert
          ...
          :title="`${quote.symbol} - ${formatCurrency(quote.price)}`"
        ...
        <UFormGroup label="Trade Type" required>
          <div class="grid grid-cols-2 gap-4">
            <UButton
              :variant="form.type === 'BUY' ? 'solid' : 'outline'"
              color="green"
              size="lg"
              block
              @click="form.type = 'BUY'"
            ...
            <UButton
              :variant="form.type === 'SELL' ? 'solid' : 'outline'"
              color="red"
              size="lg"
              block
        ...
        <UButton
          block
          size="lg"
          :color="form.type === 'BUY' ? 'green' : 'red'"
          :loading="executing"
          :disabled="!form.symbol"
          @click="executeTrade"
        >
          <UIcon :name="form.type === 'BUY' ? 'i-heroicons-arrow-trending-up' : 'i-heroicons-arrow-trending-down'" class="mr-2" />
    ...
    <UCard v-if="aiAnalysis && useAI">
      <template #header>
        <div class="flex items-center justify-between">
          ...
          <UBadge
            :color="getDecisionColor(aiRecommendation?.decision)"
            size="lg"
          >
      ...
      <div class="space-y-4">
        <div class="p-4 rounded-lg bg-blue-50 dark:bg-blue-900/20">
          ...
          <p class="text-blue-800 dark:text-blue-200">{{ aiRecommendation?.reasoning || 'No reasoning available' }}</p>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <div class="p-3 rounded-lg bg-gray-50 dark:bg-gray-800">
            ...
            <UBadge
              :color="getRiskColor(aiRecommendation?.riskAssessment)"
              class="mt-2"
            >
